...
文档平铺于 `docs/`（仅 `release/` 因发布模板路径与按版归档保留子目录）。维护规则见 [AGENTS.md「文档规则」](../AGENTS.md)。

| 文档 | 内容 |
|------|------|
| [architecture](architecture.md) | 当前架构、行为规格与关键文件索引（活文档） |
| [no-focus-picker](no-focus-picker.md) | 无焦点速贴窗口时序与 Win32 坑位（活文档） |
...
| [adr-0005-window-material](adr-0005-window-material.md) | 决策：软件渲染窗口接 DWM 材质（Mica/Acrylic）的证据链、方案与 spike 真机结论（accepted） |
