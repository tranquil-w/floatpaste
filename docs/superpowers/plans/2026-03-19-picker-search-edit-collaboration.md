...
- [ ] **Step 1: 添加 ensure_workbench_window 函数**
...
- [ ] **Step 1: 添加 open_workbench_from_picker_edit 函数**
...
- [ ] **Step 2: 添加 open_workbench_from_picker_search 函数**
...
- [ ] **Step 1: 添加 open_workbench_global 函数**
...
- [ ] **Step 2: 修改 sync_registered_shortcut 支持双快捷键**
...
- [ ] **Step 3: 添加 handle_shortcut_event 中的 Workbench 处理**
...
- [ ] **Step 1: 扩展 getCurrentWindowLabel 逻辑**
...
- [ ] **Step 3: 更新 is_picker_session_shortcut 函数**
