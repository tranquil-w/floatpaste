...
- `src-tauri/src/services/tooltip_window.rs`
- `src-tauri/src/services/image_storage.rs`
...
- `src-tauri/src/platform/windows/image_clipboard.rs`
- `src-tauri/src/platform/windows/file_clipboard.rs`
- `src-tauri/src/repository/sqlite_repository.rs`
- `src/bridge/commands.ts`
- `src/bridge/window.ts`
- `src/bridge/imageUrl.ts`
- `src/app/App.tsx`
- `src/features/picker/PickerShell.tsx`
- `src/features/picker/tooltipHtml.ts`
- `src/features/picker/tooltipState.ts`
- `src/features/picker/favoriteToggle.ts`
