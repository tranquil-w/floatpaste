...
const STYLES = {
    ...
    ? "bg-[rgba(var(--cp-accent-primary-rgb),0.12)] border-[rgba(var(--cp-accent-primary-rgb),0.3)] shadow-xs dark:bg-[rgba(var(--cp-accent-primary-rgb),0.15)] dark:border-[rgba(var(--cp-accent-primary-rgb),0.4)]"
