    ...
    <div className={STYLES.shell}>
      <header className={STYLES.header}>
        <div className="min-w-0" data-tauri-drag-region>
          ...
          <h1 className="mt-1 text-base font-semibold text-[color:var(--pg-fg-default)]">
            搜索窗口
          </h1>
        </div>
        <input
      ...
      {noticeMessage ? (
        <div className="border-b border-[color:var(--pg-danger-fg)]/20 bg-[color:var(--pg-danger-subtle)] px-4 py-2 text-sm text-[color:var(--pg-danger-fg)]">
          {noticeMessage}
        </div>
      ) : null}
            ...
            <div className="h-full overflow-y-auto">
              {items.map((item, index) => (
                <button
                  ...
                  type="button"
                >
                  <p className="line-clamp-2 text-sm text-[color:var(--pg-fg-default)]">
                    {item.contentPreview}
                  </p>
                  <div className="mt-2 flex items-center gap-2 text-xs text-[color:var(--pg-fg-subtle)]">
            ...
            <div className="flex h-full flex-col gap-4">
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0">
                  ...
                  <h2 className="mt-1 text-lg font-semibold text-[color:var(--pg-fg-default)]">
              ...
              <div className="grid gap-3 text-sm text-[color:var(--pg-fg-muted)] sm:grid-cols-2">
                <div className={STYLES.detailCard}>
                  <div className="text-xs uppercase tracking-[0.14em] text-[color:var(--pg-fg-subtle)]">
                    来源
                  </div>
                  <div className="mt-2 text-[color:var(--pg-fg-default)]">
              ...
              {detailQuery.data.type === "text" ? (
                <div className={STYLES.textPreview}>
                  <pre className="h-full overflow-auto whitespace-pre-wrap break-words text-sm leading-7 text-[color:var(--pg-fg-default)]">
