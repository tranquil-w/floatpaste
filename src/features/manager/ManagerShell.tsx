          ...
          {themeModeOptions.map((option) => (
            ...
            >
              <input
                ...
                className="mt-1 h-4 w-4 border-[color:var(--cp-border-strong)] bg-cp-base text-[color:var(--cp-accent-primary)] focus:ring-[color:var(--cp-accent-primary)] dark:bg-[color:var(--cp-control-surface)]"
                name="theme-mode"
